//+------------------------------------------------------------------+
//| MAXIMUM-SCALPER-UNLIMITED v1.03                                 |
...
input double TrailStartATR=0.45;
input double TrailDistanceATR=0.30;
input bool UseBreakEven=true;
input double BreakEvenATR=0.30;
...
void Dashboard()
{
 ...
 Comment("MAXIMUM-SCALPER-UNLIMITED v1.03\n",sym," | M1 / M5\n",
